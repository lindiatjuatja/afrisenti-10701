...
from transformers.models.bert.modeling_bert import BertLayer, BertModel, BertEmbeddings, BertEncoder, BertPooler
...
def convert_examples_to_features(examples, label_list, max_seq_length, tokenizer):
    ...
    for idx, example in enumerate(examples):
        features = {}
        features['input_ids'], features['input_mask'], features['label_ids'] = tokenizer.encode(example.text_a)#.subword_tokenize_to_ids(example.text_a)
